...
// Copyright (c) 2017 The Kingscoin developers
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 5545;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Kingscoin starting difficulty is 1 / 2^12
        ...
        nTargetSpacing = 1 * 60;  // Kingscoin: 60 Seconds
        nMaturity = 5;
         ...
         *     CTxIn(COutPoint(000000, -1), coinbase 04ffff001d01044c5957697265642030392f4a616e2f3230313420546855454772616e64204578706572696d656e7420476f6573204c6976653a204f76657273746f636b2e636f6d204973204e6f7720416363657074696e6720426974636f696e73)
        ...
        vSeeds.push_back(CDNSSeedData("167.99.234.230", "167.99.234.230"));// DNS SEEDER
		vSeeds.push_back(CDNSSeedData("80.211.61.8", "80.211.61.8"));// DNS SEEDER
		vSeeds.push_back(CDNSSeedData("80.211.106.231", "80.211.106.231"));// DNS SEEDER
		vSeeds.push_back(CDNSSeedData("206.81.15.75",  "206.81.15.75")); // DNS SEEDER
		
       
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 42); //G
        ...
        strSporkKey = "0495a745f55bcd86bef574ab2bf127c3def0558ca866b174361ccba3555c6b6e5d976ce43767127f1c5178a4503ecaabd23e1d6fced68e5a6be05a7cc026b8ecdd";
        strObfuscationPoolDummyAddress = "J95WnzdtDogiBW29hQcgwah32cnFSSs5gE";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Kingscoin: 1 day
        nTargetSpacing = 1 * 60;  // Kingscoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("test-seeds1.kingscoin.net", "test-seeds1.kingscoin.net"));
        vSeeds.push_back(CDNSSeedData("test-seeds2.kingscoin.net", "test-seeds2.kingscoin.net"));


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet kingscoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet kingscoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet kingscoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet kingscoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet kingscoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Kingscoin: 1 day
        nTargetSpacing = 1 * 60;        // Kingscoin: 1 minutes
